 ...
 */
public class OrgLoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private OrgLoginActivity self = this;
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(OrgLoginActivity.this,
